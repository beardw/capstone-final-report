...
The script for sounds attempted to retrieve 2 sounds per bird species, with a length under 7 seconds, and with a quality rating of B or higher attached to the sounds metadata. If no sounds were available under 7 seconds then the script would attempt 10 seconds, then 15 seconds, and finally allow for 1 sound at 20 seconds. This was to methodically keep asset size low because of the volume of assets and considering the storage on GitHub alongside the dashboard code.

Sounds are displayed by selecting the *Sounds* tab and reveal a standard waveform visual with a play button and red line that animates through the waveform as the play-head.
