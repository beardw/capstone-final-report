...
General species information is displayed through the ***Info*** tab on a simple UI card showing the species name

- @fig-dashboard-info A basic UI card to display species names, species code, and links.

![](images/clipboard-2530564511.png)
...
- @fig-dashboard-spectrogram The expanded spectrogram modal forthe American Robin
